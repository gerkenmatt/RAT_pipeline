...
HD_PWD='C:/Users/Kevin/Documents/New School/Fifth Year/Spring Quarter/EE 521/RAT_Pipelining_Step1/Exp. 9 Interrupts/Exp. 9 Interrupts.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SYS_WRAPPER.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SYS_WRAPPER.tcl -notrace
